...
def load_image(name: str) -> list:
    ...
    elif name == 'wall_up.png': pygame.draw.rect(f, pygame.Color('black'), pygame.Rect(0, 10, 20, 10))
    elif name == 'wall_down.png': pygame.draw.rect(f, pygame.Color('black'), pygame.Rect(0, 0, 20, 10))
    elif name == 'wall_left.png': pygame.draw.rect(f, pygame.Color('black'), pygame.Rect(10, 0, 10, 20))
    elif name == 'wall_right.png': pygame.draw.rect(f, pygame.Color('black'), pygame.Rect(0, 0, 10, 20))
    elif name == 'wall_up_left_corner.png': pygame.draw.rect(f, pygame.Color('black'), pygame.Rect(10, 10, 10, 10))
    elif name == 'wall_up_right_corner.png': pygame.draw.rect(f, pygame.Color('black'), pygame.Rect(0, 10, 10, 10))
    elif name == 'wall_down_left_corner.png': pygame.draw.rect(f, pygame.Color('black'), pygame.Rect(10, 0, 10, 10))
    elif name == 'wall_down_right_corner.png': pygame.draw.rect(f, pygame.Color('black'), pygame.Rect(0, 0, 10, 10))
...
if __name__ == '__main__':
    ...
    size_screen = (tile_width * loaded_level[1][0], tile_height * loaded_level[1][1])
